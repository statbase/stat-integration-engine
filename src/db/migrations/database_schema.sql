--
-- File generated with SQLiteStudio v3.4.4 on Wed Sep 20 14:07:39 2023
--
...
CREATE TABLE IF NOT EXISTS timeseries (
    ...
    REFERENCES data_block (data_id) ON DELETE CASCADE,
    FOREIGN KEY (
        geo_id
    )
    REFERENCES geo_unit ON DELETE CASCADE
);
